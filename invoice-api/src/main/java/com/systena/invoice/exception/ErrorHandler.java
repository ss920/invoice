...
public class ErrorHandler {
	...
	public ResponseEntity<ExceptionDto> validExceptionHandle( final MethodArgumentNotValidException e ){
		...
		if( e != null && e.getBindingResult() != null && e.getBindingResult().getFieldErrors() != null ) {
