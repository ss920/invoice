...
public class MessageConstant {
  ...
  public static Map<String, String[]> validErrorMsgParamMap = new HashMap<String,String[]>() {
    {
      // 必須チェックエラーのパラメータ
      put(KEY_ERROR_NOT_EMPTY + KEY_CLIENT_NO, new String[] {NAME_CLIENT_NO});
      put(KEY_ERROR_NOT_EMPTY + KEY_INVOICE_START_DATE, new String[] {NAME_INVOICE_START_DATE});
      put(KEY_ERROR_NOT_EMPTY + KEY_INVOICE_END_DATE, new String[] {NAME_INVOICE_END_DATE});
      put(KEY_ERROR_NOT_EMPTY + KEY_CREATE_USER, new String[] {NAME_CREATE_USER});
      put(KEY_ERROR_NOT_EMPTY + KEY_INVOICE_CREATE_DATE, new String[] {NAME_INVOICE_CREATE_DATE});

      // 形式チェックエラーのパラメータ
      put(KEY_ERROR_FORMAT + KEY_CLIENT_NO, new String[] {NAME_CLIENT_NO, FORMAT_NUMBER});
      ...
      put(KEY_ERROR_FORMAT + KEY_INVOICE_NO, new String[] {NAME_INVOICE_NO, FORMAT_NUMBER});
